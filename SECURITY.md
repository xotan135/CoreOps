...
Remote service stop and restart operations and temporary-file deletion require explicit confirmation. Preview cleanup first, review the selected minimum age, and use organizational change control for critical systems. Cleanup is permanent and files that another process needs should be excluded by choosing a conservative age.
